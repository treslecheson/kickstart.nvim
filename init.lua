...
-- Save cursor position when exiting Neovim
vim.api.nvim_create_autocmd('VimLeave', {
  pattern = '*',
  command = 'mkview',
})

-- Restore cursor position when opening Neovim
vim.api.nvim_create_autocmd('VimEnter', {
  pattern = '*',
  command = 'silent! loadview',
})

-- Optionally, you can set a file to store view data (cursor position, folds, etc.)
...
--
--vim-escape
--vim.keymap.set('i', 'uh', '<Esc>', { noremap = true, silent = true })
--vim.keymap.set('i', 'hu', '<Esc>', { noremap = true, silent = true })
--
...
--ue and tn don't work for escape
--
--
-- Diagnostic keymaps
...
--Move the cursor while in insert mode with ctrl and hjkl
